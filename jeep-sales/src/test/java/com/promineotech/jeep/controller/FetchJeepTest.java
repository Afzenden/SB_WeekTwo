...
class FetchJeepTest {
	...
	void testThatJeepsAreReturnedWhenAValidModelAndTrimAreSupplied() {
		...
		DefaultJeepSalesController expected = new DefaultJeepSalesController();
		System.out.println(expected.buildExpected());
		assertThat(response.getBody()).isEqualTo(expected.buildExpected());
	}
